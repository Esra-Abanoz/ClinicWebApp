...
{
    public static class Sha256Encryptography
    {
        /// <summary>
        ...
        public static string EncryptString(this string InputText, string Password = "")
        {

            Password = string.IsNullOrEmpty(Password) ? "ca45d4f4-6060-4796-b512-2357fb460ef2" : Password;
        ...
        public static string DecryptString(this string InputText, string Password = "")
        {
            Password = string.IsNullOrEmpty(Password) ? "ca45d4f4-6060-4796-b512-2357fb460ef2" : Password;
            RijndaelManaged RijndaelCipher = new RijndaelManaged();
